...
RUN_POSTGRES_TESTS = os.getenv("RUN_POSTGRES_TESTS", "").lower() in {"1", "true", "t", "yes", "y", "on"}
DATABASE_URL = os.getenv("DATABASE_URL", "").strip()


@pytest.mark.skipif(not RUN_POSTGRES_TESTS, reason="set RUN_POSTGRES_TESTS=1 to enable")
